...
export default function AppRouter() {
  ...
  const routes = useMemo(
    () => ({
      ...
      [ROUTES.USER_MY_PAGE]: guarded(UserMyPage, ['USER']),
      [ROUTES.USER_UPDATE]: guarded(UserUpdatePage, ['USER']),
      [ROUTES.PROFILE]: guarded(ProfilePage, ['USER']),
      [ROUTES.PROFILE_UPDATE]: guarded(ProfileUpdatePage, ['USER']),
      [ROUTES.AI_EVALUATION]: guarded(AiEvaluationPage, ['USER']),
      [ROUTES.RESUMES]: guarded(ResumeListPage, ['USER']),
      [ROUTES.RESUME_CREATE]: guarded(ResumeCreatePage, ['USER']),
      [ROUTES.RESUME_DETAIL]: guarded(ResumeDetailPage, ['USER']),
      [ROUTES.RESUME_UPDATE]: guarded(ResumeUpdatePage, ['USER']),
      [ROUTES.MY_APPLICATIONS]: guarded(MyApplicationListPage, ['USER']),
      [ROUTES.MY_APPLICATION_DETAIL]: guarded(MyApplicationDetailPage, ['USER']),
      [ROUTES.RECEIVED_OFFERS]: guarded(PositionOfferReceivedListPage, ['USER']),
      [ROUTES.RECEIVED_OFFER_DETAIL]: guarded(PositionOfferReceivedDetailPage, ['USER']),
      [ROUTES.JOBS]: <JobListPage />,
      [ROUTES.JOB_DETAIL]: <JobDetailPage />,
      [ROUTES.JOB_APPLY]: guarded(JobApplyPage, ['USER']),
      [ROUTES.JOB_BOOKMARKS]: guarded(JobBookmarkPage, ['USER']),
